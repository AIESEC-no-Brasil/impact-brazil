const config = {
	...
	api:                window.webpackHotUpdate ? "http://localhost:8000/api/" : "https://impactbrazil.org/api/api/",
	...
	endpoints:          {
		...
		oppCacheUpdate: id => `opportunity/cache_update/${id}.json`,
		lcs:            "lcs.json",
		lc:             id => `lc/${id}.json`,
		lcByName:       name => `lc/by_name/${name}.json`,
		cities:         "cities.json",
